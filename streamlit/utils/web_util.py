    ...
    with col1:
        st.markdown(
            ...
            <div style="display: flex; align-items: center;">
                ...
                <h3 style="margin:0;font-size:28px;color:#FFB733;font-weight:700;letter-spacing:0.8px;font-family: 'Lato', 'Helvetica Neue', sans-serif; font-weight:300;"><b>AMBER QUANT</b></h3>
            </div>
            """,
            unsafe_allow_html=True
        )
